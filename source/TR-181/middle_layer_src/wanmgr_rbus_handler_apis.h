...
#define WANMGR_CONFIG_WAN_CURRENT_IPV4_GATEWAY       "Device.X_RDK_WanManager.Current_IPv4_Default_GateWay"
#define WANMGR_CONFIG_WAN_CURRENT_IPV6_GATEWAY       "Device.X_RDK_WanManager.Current_IPv6_Default_GateWay"
